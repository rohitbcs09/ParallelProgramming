...
void MM_rotate_A_broadcast_B(int n, int p, int rank) {
    ...
    */
    ...
    for(int l = 1; l <= sqrt_p; l++) {
        ...
        //printMatrix(bcast_ptr, proc_mat_size);
        ...
        if (k == p_src_row) {
           ...
           /*
           std::cout << "Hello \n";
           for (int i = 0; i < proc_mat_size * proc_mat_size; ++i) {
              std::cout << g_bcast_ptr[i] << " ";
           } 
           std::cout << "\nHello \n";
           */
        ...
        /*
        std::cout << "Send start i = " << p_src_row << " j = " << p_src_col << " l = " << l << std::endl;
        for (int i = 0; i < proc_mat_size * proc_mat_size; ++i) {
              std::cout << g_bcast_ptr[i] << " ";
           }
        std::cout << "Send end i = " << p_src_row << " j = " << p_src_col << " l = " << l << std::endl;
        */
        ...
        */
        ...
        /*
        std::cout << "Rcv start i = " << p_src_row << " j = " << p_src_col << " l = " << l << std::endl; 
        printMatrix(rcv_mat, proc_mat_size);
        std::cout << "Rcv end i = " << p_src_row << " j = " << p_src_col << " l = " << l << std::endl;
        */
